...
function renderMenu($highlighted_item_class){
    ...
    if ($loggedInUser->user_id == $master_account){
        $hooks['#HEADERMESSAGE#'] = "<span class='navbar-center navbar-brand'><a href='../account/map.php' class='btn btn-primary'>Root Map</a></span>";
    } else {
        $hooks['#HEADERMESSAGE#'] = "";
    }
...
<div class="navbar-header">
    ...
    <a class="navbar-brand" href="../account/user_map.php">#WEBSITENAME#</a>
    #HEADERMESSAGE#
</div>
